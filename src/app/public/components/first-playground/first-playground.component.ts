...
@Component({
  selector: 'first-playground',
  templateUrl: './first-playground.component.html',
  styleUrls: ['./first-playground.component.scss']
})
export class FirstPlaygroundComponent implements OnInit {
